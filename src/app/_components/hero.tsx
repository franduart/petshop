...
export function Hero(){
    return(
        ...
        <section className="bg-[#ffb703] text-white relative overflow-hidden">
                ...
                <div className='space-y-6'>
                    ...
                    <div>
                        ...
                        className="bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center w-fit gap-2">
                           <WhatsappLogo className='w-5 h-5 '/> Link whatsApp</a>
                    </div>

                    <div className="mt-8">
                        <p className="text-sm mb-4">
                            <b className="bg-black text-white px-2 rounded-md py-1">5% de desconto na primeira compra</b>
                        </p>
